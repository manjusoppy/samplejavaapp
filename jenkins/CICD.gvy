        ...
        stage('build & push docker image') {
	         steps {
              withDockerRegistry(credentialsId: 'DOCKER_HUB_LOGIN', url: 'https://index.docker.io/v1/') {
                    ...
                    sh script: 'docker build --file Dockerfile --tag docker.io/manjusoppy/samplejavaapp:$BUILD_NUMBER .'
                    sh script: 'docker push docker.io/manjusoppy/samplejavaapp:$BUILD_NUMBER'
              }	
           }		
        }
        stage('deploy-QA') {
